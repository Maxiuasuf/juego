...
def pantalla_inicial(screen):
    imagen_inicial = pygame.transform.scale(pygame.image.load("C:/Users/maxi/Desktop/programacion 1 2023/tp_video_juego.py/wall4.jpg"))
...
def main():
    ...
    while True:
        ...
        if tiempo_formateado == "00:00" and nave_propia.vidas >= 1:
            ...
            tiempo_inicial = time.time()  # Reinicia el cronómetro
